"""Codex-native fablize-style task modes.

This module is deliberately deterministic and local-only. It ports the useful
fablize procedures into `.forge` gates without importing Claude hooks, `.fablize`
state, setup scripts, or always-on routing.
"""
...
def contract_text() -> str:
    return (
        "Mode lock: scaffold may write .forge/MODES (render/debug/multi_story). "
